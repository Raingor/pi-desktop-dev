...
export const BUILTIN_PROVIDERS: Provider[] = [
  {
    id: 'anthropic', name: 'Anthropic', type: 'builtin', api: 'anthropic-messages',
    hasAuth: true, authMethod: 'env',
    models: [
  ...
  {
    id: 'openai', name: 'OpenAI', type: 'builtin', api: 'openai-completions',
    hasAuth: true, authMethod: 'env',
    models: [
  ...
  {
    id: 'deepseek', name: 'DeepSeek', type: 'builtin', api: 'openai-completions',
    hasAuth: true, authMethod: 'env',
    models: [
  ...
  {
    id: 'opencode', name: 'OpenCode', type: 'builtin', api: 'openai-completions',
    hasAuth: true, authMethod: 'file',
    models: [
  ...
  {
    id: 'opencode-go', name: 'OpenCode Go', type: 'builtin', api: 'openai-completions',
    hasAuth: true, authMethod: 'file',
    models: [
      { id: 'deepseek-v4-flash', name: 'DeepSeek V4 Flash', reasoning: false, input: ['text'], contextWindow: 128000, maxTokens: 8192, cost: { input: 0.3, output: 0.6, cacheRead: 0.15, cacheWrite: 0.3 }, enabled: true },
  ...
  {
    id: 'sensenova', name: 'SenseNova', type: 'builtin', api: 'openai-completions',
    hasAuth: true, authMethod: 'env',
    models: [
  ...
  {
    id: 'google', name: 'Google Gemini', type: 'builtin', api: 'google-generative-ai',
    hasAuth: true, authMethod: 'env',
    models: [
  ...
  {
    id: 'openrouter', name: 'OpenRouter', type: 'builtin', api: 'openai-completions',
    hasAuth: false, authMethod: 'none',
    models: [
  ...
  {
    id: 'mistral', name: 'Mistral', type: 'builtin', api: 'mistral-conversations',
    hasAuth: false, authMethod: 'none',
    models: [
  ...
  {
    id: 'github-copilot', name: 'GitHub Copilot', type: 'builtin', api: 'openai-completions',
    hasAuth: false, authMethod: 'none',
    models: [
  ...
  {
    id: 'groq', name: 'Groq', type: 'builtin', api: 'openai-completions',
    hasAuth: false, authMethod: 'none',
    models: [
